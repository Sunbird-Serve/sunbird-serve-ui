                ...
                <div className = 'calendar'>
                  <div>
                    ...
                    <div style={{float: 'left'}}>
                        <button className = 'changeMonthButton' type="button" onClick={() => dateHandler(currentDate, '-')} ><ArrowBackIosNewIcon style = {{fontSize: 'smaller', margin: '5px 0px 3px 0px'}}/></button>
                        <button className = 'changeMonthButton' type="button" onClick={() => dateHandler(currentDate, '+')} ><ArrowForwardIosIcon style = {{fontSize: 'smaller', margin: '5px 0px 3px 0px'}}/></button>
                    </div>
                  </div>
                  <br style={{clear: 'both'}}/>
                    <div className="box">
                      <div className="content">
                        <div className="label"><VisibilityIcon style = {{fontSize: 'small', paddingRight: '0.5vw', color: '#888'}} />Needs</div>
                        <div className="value">565</div>
                      </div>
                      <div className="content">
                        <div className="label"><VisibilityIcon style = {{fontSize: 'small', paddingRight: '0.5vw', color: '#888'}} />Volunteers</div>
                        <div className="value">565</div>
                      </div>
                    </div>
                  <br style={{clear: 'both'}}/>
                ...
                selectedDate
                  ...
                  :
                    <div style = {{height: '80vh', display:'flex', flexDirection:'column'}}>
                      <EventIcon style = {{fontSize: '150px', margin:'auto auto 0 auto', color: '#c4c4c4'}}/>
                      <span style = {{margin:'0 auto auto auto'}}>Select a date to display the needs</span>
                    </div>
                  }
                </div>
            </div>
