...
const ModifyNeed = (props) => {
  ...
  const [startYMD, setStartYMD] = useState(
    props.data.occurrence ? props.data.occurrence.startDate.substr(0, 10) : ""
  );
  const [endYMD, setEndYMD] = useState(
    props.data.occurrence ? props.data.occurrence.endDate.substr(0, 10) : ""
  );
  ...
  useEffect(() => {
    setDataOccurrence({
      ...
      days: selectedDays.map((obj) => obj.day).join(", "),
    });
  }, [selectedDays]);
  ...
  const handleDone = (e) => {
    ...
    axios
      .put(`${configData.NEED_GET}/update/${needId}`, dataToPost)
      .then((response) => {
  ...
  return (
    <Modal show={true}>
      <Modal.Header closeButton onHide={props.handleClose}>
        <Modal.Title>Modify Need</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className="needNominations">
          <div className="wrapTabs">
            <button onClick={() => setNomin(true)}>
              <div className={nomin ? "ulTab" : null}>Nominations</div>
            </button>
            <button onClick={() => setNomin(false)}>
              <div className={nomin ? null : "ulTab"}>Need Info</div>
            </button>
          </div>
            ...
            <div className="needInfoBox">
              <div className="needInfoBar">
                <div className="wrapInfoName">
                  <div className="needIName">
                    {data.need.name ? data.need.name : "-"}
                  </div>
                ...
                <div className="wrap-modify-button">
                  {status === "Approved" && !modify && (
                    <button className="modify-button" onClick={handleModify}>
                      Modify
                    </button>
                  )}
                  {modify && (
                    <button className="modify-button" onClick={handleDone}>
                      Done
                    </button>
                  )}
                </div>
              ...
              <form className="needInfoForm" id="modifyForm">
                ...
                <div className="needIFormTop">
                  <div className="needInfoTopLeft">
                    ...
                    <div className="itemNInfo">
                      ...
                      {!modify && (
                        <span>
                          {data.need.needPurpose ? data.need.needPurpose : "-"}
                        </span>
                      )}
                      {modify && status == "Approved" && (
                        <span>
                  ...
                  <div className="needInfoTopRight">
                    ...
                    <div className="itemNInfo">
                      ...
                      {
                        <span>
                          {data.needType.name ? data.needType.name : ""}
                        </span>
                      }
                    </div>
                    {/* Need Status */}
                ...
                <div className="wrap-sessionInfo">
                    ...
                    <div className="itemDateInfo">
                      ...
                      <div className="wrap-itemDateMN">
                        <div className="itemDate-modified">
                          ...
                          <span>
                            {data.occurrence
                              ? data.occurrence.endDate.substr(0, 10)
                              : "-"}
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="itemNInfo-dayNtime">
                      ...
                      <div className="itemDaysTime">
                        ...
                        {data.timeSlots.map((slot, index) => (
                          <span key={index}>
                            {" "}
                            {slot.day}{" "}
                            {formatTime(slot.startTime.substr(11, 5))} -{" "}
                            {formatTime(slot.endTime.substr(11, 5))}{" "}
                          </span>
                        ))}
                      </div>
                    )}
                    ...
                    {modify && (
                      <div className="itemWrapNInfoFreqMN">
                ...
                <div className="needIFormBottom">
                  <div className="formBLeft">
                    ...
                    {data && (
                      <div className="itemNInfo">
                        ...
                        {
                          <span>
                            {data.needRequirement.skillDetails
                              ? data.needRequirement.skillDetails
                              : ""}
                          </span>
                        }
                  ...
                  <div className="formBRight">
                    ...
                    <div className="itemNInfo">
                      ...
                      {
                        <span>
                          {data.needRequirement.volunteersRequired
                            ? data.needRequirement.volunteersRequired
                            : ""}
                        </span>
                      }
            ...
            <span>
              <CheckIcon
                style={{
                  ...
                  width: "20px",
                  borderRadius: "50%",
                  backgroundColor: "#2F9346",
                  padding: "2px",
                  color: "#4D4D4D",
                  margin: "2px 5px",
                }}
              />
              Nomination has been accepted successfully
            </span>
