    ...
    <div className="loginForm row">
      {!showResetForm ? (
        ...
        <form className="resetPasswordForm col-12 col-sm-7 offset-sm-1 mt-sm-5">
          <div className="titleLogin">Forgot/Reset Password</div>
          ...
          {!resetSent ? (
            <>
              ...
              <div className="btnLogin">
                <button type="submit" onClick={handleResetPassword}>Send Reset Email</button>
              </div>
            </>
          ) : (
          ...
          <div className="backToLogin">
            <a href="#" onClick={toggleResetForm}>Back to Login</a>
          </div>
